...
from drop_eval import (answer_json_to_structured_data, get_metrics as drop_em_and_f1, answer_json_to_strings)
...
class DropEmAndF1(object):
    ...
    def __call__(self, prediction: Union[str, List], ground_truths: List, question_id):  # type: ignore
        """
        Parameters
        ----------
        ...
        ground_truth_answers = [answer_json_to_structured_data(annotation) for annotation in ground_truths]
        ground_truth_answer_strings = [g[0] for g in ground_truth_answers]
        ...
        self._count += 1
        self._prediction.append((question_id, prediction, str(ground_truth_answer_strings[0])))
